...
const fakeGroupLogsByDate = [
  ...
  {
    logStreamName: 'mockLogStream',
    timestamp: 1466612103825,
    message: '{"timestamp":"2016-06-22T16:16:23.251Z","tags":{"debug":true,"blorb":true},"message":{"margi": 1,"jindak":{"":true}}}',
    ingestionTime: 1466612185629,
    eventId: '32706544603763553389760760118557256062314077895186776065'
  },
  {
    logStreamName: 'mockLogStream',
    timestamp: 1466612103785,
    message: '{"timestamp":"2016-06-22T16:16:23.251Z","tags":{"debug":true,"blorb":true},"message":{"igram": 1,"jindak":{"":true}}}',
    ingestionTime: 1466612185629,
    eventId: '32706544603763553389760760118557256062314077895186776065'
  },
...
class FakeCloudwatchLogs {
    ...
    // these methods can be substitued in on a
    // case-by-case basis for different tests:
    _____filterLogEventsSortByDate(params, callback) {
      callback(null, { events : fakeGroupLogsByDate });
    }
};
